...
//DATI UTENTE
  ...
  let tripDistance = parseInt(prompt('Inserisci adesso la distanza del viaggio in KM')); //number
  console.log(tripDistance);

//PREZZO BASE
  //prezzo totale per la distanza da percorrere calcolato in base alle info fornite dal cliente:
    // 1. 1km = 0.21€ ;
  let kmPrice = tripDistance * 0.21; //number
  console.log(`Il prezzo basato sulla distanza per questo biglietto è di ${kmPrice} €`); //string
...
//OUTPUT
  ...
  let finalPrice = kmPrice - discount ;
